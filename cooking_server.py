...
class CookingProcessing(threading.Thread):
    def __init__(self):
    ...
    def run(self):
        ...
        LOG.info(LOG_TAG + "cooking processing thread started")
        try:
        ...
        LOG.debug(LOG_TAG + "cooking processing thread terminated")
    ...
    def _handle_img(self, img):
        ...
        ## get current state
        rtn_msg, state = cc.process(img, resize_ratio, display_list)
        if state is None:
            return "None"
...
if __name__ == "__main__":
    ...
    cooking_processing = CookingProcessing()
    cooking_processing.start()
    cooking_processing.isDaemon = True
    ...
    try:
        ...
        if cooking_processing is not None:
            cooking_processing.terminate()
